...
Deploy = function(contractFiles, blockchainConfig, contractsConfig, chainManager, withChain, _web3) {
  this.contractsManager = contractsConfig;
  this.contractsConfig = this.contractsManager.config();
...
Deploy.waitForContract = function(transactionHash, cb) {
  this.web3.eth.getTransactionReceipt(transactionHash, function(e, receipt) {
    ...
    if (contract.address !== undefined) {
      ...
      if (chainContract != undefined && this.web3.eth.getCode(chainContract.address) !== "0x") {
        ...
        this.deploy_contract(contractObject, contractParams, function(contractAddress) {
          if (this.web3.eth.getCode(contractAddress) === "0x") {
            console.log("=========");
